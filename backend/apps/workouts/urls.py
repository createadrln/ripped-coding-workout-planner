...
urlpatterns = [
    ...
    path('exercise-success/', lambda request: render(request, 'exercise_success.html'), name='exercise_success'),
    path('create-workout-template/', views.create_workout_template, name='create_workout_template'),
    path('workout-template-success/', lambda request: render(request, 'workout_template_success.html'), name='workout_template_success'),
